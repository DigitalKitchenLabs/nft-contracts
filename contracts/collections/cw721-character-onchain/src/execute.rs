...
impl Cw721CharacterContract<'_> {
    ...
    pub fn execute(
        ...
        match msg {
            ...
            ExecuteMsg::LockCharacter { token_id } => {
                self.lock_character(deps, env, info, token_id)
            }
            ExecuteMsg::Modify {
                token_id,
                new_values,
