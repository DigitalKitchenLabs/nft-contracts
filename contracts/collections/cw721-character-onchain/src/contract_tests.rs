...
fn minting() {
    ...
    let mint_msg = ExecuteMsg::Mint {
        ...
        extension: Metadata {
            ...
            eye_type: Some(String::from("Aviator")),
            mouth_type: Some(String::from("Cool")),
...
fn approving_all_revoking_all() {
    ...
    let demeter2 = String::from("demeter");
