...
//This is saved during instantiation and is the address queried to check if the user owns the traits
pub const TRAIT_COLLECTION_ADDRESS: Item<Addr> = Item::new("traits_collection_address");
